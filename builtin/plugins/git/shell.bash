# Branch-resolution helpers + power functions backing the git aliases. Identical portable body
# to shell.zsh. Aliases that interpolate `$(git_main_branch)` etc. resolve through these at call time.
