...
aiTerminal has **1386 unit tests** and **280 scenarios**, and the whole suite runs in a
...
1386 of them (918 in `framework`, 337 in `corelib`, 131 in `platform`), beside the code
