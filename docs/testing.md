...
aiTerminal has **1510 unit tests** and **328 scenarios**, and the whole suite runs in a
...
1510 of them (1038 in `framework`, 337 in `corelib`, 135 in `platform`), beside the code
