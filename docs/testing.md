...
aiTerminal has **1528 unit tests** and **329 scenarios**, and the whole suite runs in a
...
1528 of them (1055 in `framework`, 337 in `corelib`, 136 in `platform`), beside the code
