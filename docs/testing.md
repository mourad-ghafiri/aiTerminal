...
aiTerminal has **1550 unit tests** and **335 scenarios**, and the whole suite runs in a
...
1550 of them (1076 in `framework`, 337 in `corelib`, 137 in `platform`), beside the code
