...
aiTerminal has **1521 unit tests** and **328 scenarios**, and the whole suite runs in a
...
1521 of them (1048 in `framework`, 337 in `corelib`, 136 in `platform`), beside the code
