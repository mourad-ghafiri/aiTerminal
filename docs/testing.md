...
aiTerminal has **1530 unit tests** and **329 scenarios**, and the whole suite runs in a
...
1530 of them (1057 in `framework`, 337 in `corelib`, 136 in `platform`), beside the code
