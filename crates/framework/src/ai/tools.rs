...
pub const DEFAULT_SAFE_TOOLS: &[&str] = &[
    ...
    "memory.search", "memory.get", "memory.sessions", "data.query", "data.get", "data.count", "queue.peek", "queue.size",
...
pub const DEFAULT_CODER_TOOLS: &[&str] = &[
    ...
    "memory.search", "memory.get", "memory.sessions", "memory.add", "memory.update", "memory.forget", "memory.link",
