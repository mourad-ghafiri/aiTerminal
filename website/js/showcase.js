    ...
    flow: {
      ...
      demo(w, myEpoch) {
        run(w, myEpoch, [
          ...
          { do: "out", spans: [DIM("  4 nodes · 3 agents · 24 tools · 6 skills · 4 at a time")] },
          { do: "out", spans: [OK("     ✓"), FG(" plan     "), DIM("@planner    claude-sonnet-5   3.1s  1.2k   ⚙2")], ms: 300 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [ACC("     ⠻"), FG(" gather   "), DIM("@researcher claude-sonnet-5              × 5 items  ⚙ web.search")], ms: 900 },
          { do: "out", spans: [OK("     ✓"), FG(" gather   "), DIM("@researcher claude-sonnet-5  22.4s 18.9k  ⚙31  × 5 items")], ms: 300 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [OK("     ✓"), FG(" compare  "), DIM("@researcher claude-sonnet-5   8.2s  6.4k   ⚙4")], ms: 240 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [OK("     ✓"), FG(" report   "), DIM("@writer     claude-sonnet-5   6.7s  3.1k")], ms: 240 },
          ...
          { do: "out", spans: [DIM("  8 nodes · 6 agents · 69 tools · 24 skills · 4 at a time")] },
          { do: "out", spans: [OK("     ✓"), FG(" plan        "), DIM("@planner   claude-sonnet-5   4.2s  3.1k   ⚙3")], ms: 240 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [DIM("  ├─"), OK(" ✓"), FG(" explore     "), DIM("@explorer  claude-sonnet-5   8.1s  9.4k  ⚙12")], ms: 200 },
          { do: "out", spans: [DIM("  └─"), OK(" ✓"), FG(" conventions "), DIM("@explorer  claude-sonnet-5   7.6s  8.8k   ⚙9   ← both scouts, at once")], ms: 200 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [ACC("     ⠻"), FG(" apply       "), DIM("@coder     claude-opus-5    12.3s   ⚙4  fs.edit src/cli.rs")], ms: 800 },
          { do: "out", spans: [OK("     ✓"), FG(" apply       "), DIM("@coder     claude-opus-5    12.3s  6.2k   ⚙9")], ms: 200 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [ERR("     ✗"), FG(" verify      "), DIM("@tester    claude-sonnet-5   9.8s  4.1k   ⚙6  VERDICT: FAIL")], ms: 300 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [DIM("  ├─"), OK(" ✓"), FG(" fix         "), DIM("@coder     claude-opus-5     7.2s  3.3k   ⚙5")], ms: 240 },
          { do: "out", spans: [DIM("  └─"), OK(" ✓"), FG(" review      "), DIM("@reviewer  claude-sonnet-5   6.4s  5.1k   ⚙4")], ms: 200 },
          { do: "out", spans: [DIM("  │")] },
          { do: "out", spans: [OK("     ✓"), FG(" summary     "), DIM("@writer    claude-sonnet-5   3.9s  1.9k")], ms: 200 },
