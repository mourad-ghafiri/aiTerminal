    ...
    flow: {
      ...
      demo(w, myEpoch) {
        run(w, myEpoch, [
          ...
          { do: "out", spans: [OK("  │ ✓ plan            ⚙2 │    │ ⠻ gather             │")], ms: 200 },
          { do: "out", spans: [OK("  │ @planner             │───▸│ @researcher × 5      │")], ms: 200 },
          { do: "out", spans: [OK("  │ 3.1s · 1.2k          │    │ ⚙ web.search         │")], ms: 900 },
          { do: "out", spans: [OK("  ╰──────────────────────╯    ╰──────────────────────╯")], ms: 200 },
          { do: "out", spans: [DIM("              ╎╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌▾")] },
          { do: "out", spans: [OK("  ╭──────────────────────╮    ╭──────────────────────╮")], ms: 200 },
          { do: "out", spans: [OK("  │ ✓ compare         ⚙4 │    │ ✓ report             │")], ms: 200 },
          { do: "out", spans: [OK("  │ @researcher          │───▸│ @writer              │")], ms: 200 },
          { do: "out", spans: [OK("  │ 8.2s · 6.4k          │    │ 6.7s · 3.1k          │")], ms: 200 },
          { do: "out", spans: [OK("  ╰──────────────────────╯    ╰──────────────────────╯")], ms: 200 },
          ...
          { do: "out", spans: [OK("  ╭──────────────────────╮    ╭──────────────────────╮    ╭──────────────────────╮    ╭──────────────────────╮")], ms: 200 },
          { do: "out", spans: [OK("  │ ✓ plan            ⚙3 │    │ ✓ explore        ⚙12 │    │ ✓ conventions     ⚙9 │    │ ✓ apply           ⚙9 │")], ms: 200 },
          { do: "out", spans: [OK("  │ @planner             │───▸│ @explorer            │    │ @explorer            │───▸│ @coder               │")], ms: 200 },
          { do: "out", spans: [OK("  │ 4.2s · 3.1k          │    │ 8.1s · 9.4k          │    │ 7.6s · 8.8k          │    │ 12.3s · 6.2k         │")], ms: 200 },
          { do: "out", spans: [OK("  ╰──────────────────────╯    ╰──────────────────────╯    ╰──────────────────────╯    ╰──────────────────────╯")], ms: 200 },
          { do: "out", spans: [DIM("              ╎╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╎╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌▴                           ╎")] },
          { do: "out", spans: [DIM("              ▾╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╎")] },
          { do: "out", spans: [ERR("  ╭──────────────────────╮"), OK("    ╭──────────────────────╮    ╭──────────────────────╮    ╭──────────────────────╮")], ms: 300 },
          { do: "out", spans: [ERR("  │ ✗ verify       ⚙6 ×2 │"), OK("    │ ✓ fix             ⚙5 │    │ ✓ review          ⚙4 │    │ ✓ summary            │")], ms: 300 },
          { do: "out", spans: [ERR("  │ @tester              │"), OK("───▸│ @coder               │    │ @reviewer            │───▸│ @writer              │")], ms: 240 },
          { do: "out", spans: [ERR("  │ 9.8s · 4.1k          │"), OK("    │ 7.2s · 3.3k          │    │ 6.4s · 5.1k          │    │ 3.9s · 1.9k          │")], ms: 240 },
          { do: "out", spans: [ERR("  ╰──────────────────────╯"), OK("    ╰──────────────────────╯    ╰──────────────────────╯    ╰──────────────────────╯")], ms: 200 },
